<x-app-layout>
    <div class="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] md:p-6">
        <h2 class="text-2xl font-bold text-gray-800 dark:text-white/90 mb-6">Manage Accommodations</h2>
        <livewire:admin.accommodation-manager />
    </div>
